export const SquigglesABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "_invocations", type: "uint256" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "additionalPayeePercentage", type: "uint256" },
  ...
  {
    constant: false,
    inputs: [{ internalType: "address payable", name: "_artblocksAddress", type: "address" }],
  ...
  {
    constant: false,
    inputs: [{ internalType: "uint256", name: "_artblocksPercentage", type: "uint256" }],
  ...
  },
  {
    ...
    inputs: [
      { internalType: "uint256", name: "_projectId", type: "uint256" },
      { internalType: "address payable", name: "_additionalPayee", type: "address" },
      { internalType: "uint256", name: "_additionalPayeePercentage", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { internalType: "uint256", name: "_projectId", type: "uint256" },
      { internalType: "address payable", name: "_artistAddress", type: "address" },
    ],
